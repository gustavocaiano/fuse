...
A metodologia adotada para a realização deste trabalho académico baseia-se no modelo de ``Research Process'' proposto por B. J. Oates no livro ``Researching Information Systems and Computing'' \cite{oates_research}, ilustrado na Figura \ref{fig:research_process}.

\begin{figure}[h]
\centering
% \includegraphics[width=\textwidth]{ch3/assets/oates_process} % Placeholder para imagem
\caption{Diagrama de ``Research Process'' de B. J. Oates, aplicado ao contexto do projeto.}
