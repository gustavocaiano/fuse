...
\begin{enumerate}
    ...
    \item \textbf{Testes:} Validação da solução através de testes unitários e funcionais, em conjunto com a validação do \gls{MVP} em ambiente controlado ou cenário real.
