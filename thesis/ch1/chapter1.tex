...
\todo{adicionar aqui os requisitos da entidade}exemplo: é necessário que a solução tenha X e que seja feita em Y
...
O documento inclui ainda a Bibliografia com todas as referências consultadas e utilizadas, bem como os apêndices: o \autoref{AppendixA}, que contém o link para download das respostas relativas ao questionário apresentado em formato de entrevista junto dos \glspl{OPC}, e o \autoref{AppendixB}, que disponibiliza o Project Charter na sua versão integral.
