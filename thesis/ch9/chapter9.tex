...
O planeamento apresentado no \autoref{sec:planeamento}, suportado por uma análise de riscos e cronograma detalhado, demonstra a possibilidade da execução técnica e temporal do projeto, estabelecendo uma rota clara para a fase de implementação que se segue.


\todo{secção a dizer que isto foi uma das soluções, mas com o decorrer do trabalho concluiu-se que a deteção em edge computing tem lugar a ser considerada etc etc}
