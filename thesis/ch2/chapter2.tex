...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.15\linewidth}|p{0.35\linewidth}|p{0.2\linewidth}|p{0.2\linewidth}|}
		\hline
		\textbf{PICOCS} & \textbf{Parte da RQ} & \textbf{I/E} & \textbf{Sub string} \\ \hline
		\textbf{P}  & Estudos envolvendo dispositivos IoT heterogéneos e CCTV & I - Estudos que considerem heterogeneidade \newline E - Anteriores a 2018 & >=2018; IoT; Heterogeneous; CCTV \\ \hline
		\textbf{I}  & Arquiteturas de software, Middleware e Camadas de Abstração & I - Estudos sobre padrões de design e abstração \newline E - Soluções proprietárias fechadas & Software Architecture; Middleware; Abstraction Layer; Design Patterns \\ \hline
		\textbf{C}  & --- & --- & --- \\ \hline
		\textbf{O} & Arquiteturas de referência e interoperabilidade & I - Estudos que propõem ou validam arquiteturas & Architecture; Interoperability; Framework \\ \hline
		\textbf{C} & Engenharia de Software e Sistemas Distribuídos & I - Académico \newline I - Indústria & Software Engineering; Distributed Systems \\ \hline
		\textbf{S}  & Estudos de caso e Propostas de Arquitetura & I - Case Studies \newline I - System Proposals \newline E - Opiniões sem validação & Case study; Proposal; Prototype \\ \hline
	\end{tabular}
\end{table}

A tabela inclui os critérios de inclusão e exclusão (I/E) relacionados com cada parte da questão de investigação, bem como as possíveis sub strings utilizadas para conduzir a pesquisa nas bases de dados científicas. Apenas estudos de 2018 em diante que contemplem arquiteturas de software ou middleware para integração de dispositivos heterogéneos foram considerados.
